...
<head>
  ...
  <link rel="apple-touch-icon" sizes="114x114"
    href="../Frontend/images/xapple-touch-icon-114x114.png.pagespeed.ic.Fi5O5s2tzL.png" />
  <link rel="apple-touch-icon" sizes="120x120"
    href="../Frontend/images/xapple-touch-icon-120x120.png.pagespeed.ic.uPQH0sygdV.png" />
  <link rel="apple-touch-icon" sizes="144x144"
    href="../Frontend/images/xapple-touch-icon-144x144.png.pagespeed.ic.yZ9-_sm5OF.png" />
  <link rel="apple-touch-icon" sizes="152x152"
    href="../Frontend/images/xapple-touch-icon-152x152.png.pagespeed.ic.gThaVrKtXF.png" />
  <link rel="apple-touch-icon" sizes="180x180"
    href="../Frontend/images/xapple-touch-icon-180x180.png.pagespeed.ic.Q8Pmsj5fQM.png" />

  <link rel="stylesheet" type="text/css" href="../Frontend/rs-plugin/css/A.settings.css.pagespeed.cf.xeOyGChsgq.css"
    media="screen" />
  ...
  <link rel="stylesheet" type="text/css"
    href="../Frontend/css/A.carousel.css%2bbxslider.css%2cMcc.jgeTii-u52.css.pagespeed.cf.STKSIMl7GF.css" />


  <link rel="stylesheet" type="text/css"
    href="../Frontend/A.style.css%2bcss%2c%2c_custom.css%2cMcc.HvWh1qoob-.css.pagespeed.cf.pWH5huNcWh.css" />
...
<body>
  ...
  <div id="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-md-6 text-right">
            <ul class="list-inline">
              ...
              <li class="dropdown">
                <a  href="./dashboard/dashboard.php" ><i class="fa fa-lock"></i>Admin</a>
        ...
        <div class="hovermenu ttmenu">
          <div class="navbar navbar-default" role="navigation">
            <div class="navbar-header">
              ...
              <div class="logo">
                <a class="navbar-brand" href="index-2.html"><img src="../Frontend/images/xlogo.png.pagespeed.ic.vap6Ukaf0i.png"
                    alt=""></a>
              </div>
            </div>
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="dropdown ttmenu-half"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Home <b
                ...
                <li class="dropdown ttmenu-half"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Courses <b
                      class="fa fa-angle-down"></b></a>
                      ...
                      <div class="ttmenu-content">
                        ...
                        <div class="row">
                          <div class="col-md-3 col-sm-6 nopadding">
                            <img class="img-thumbnail" src="../Frontend/upload/xservice_01.png.pagespeed.ic.2iuJZT3CaV.png" alt="">
                          </div>
                          <div class="col-md-3 col-sm-6 nopadding">
                            <img class="img-thumbnail" src="../Frontend/upload/xservice_02.png.pagespeed.ic.c6RThoxSWC.png" alt="">
                          </div>
                          <div class="col-md-3 col-sm-6 nopadding">
                            <img class="img-thumbnail" src="../Frontend/upload/xservice_03.png.pagespeed.ic.E_Ew4wn4ZP.png" alt="">
                          </div>
                          <div class="col-md-3 col-sm-6 nopadding">
                            <img class="img-thumbnail" src="../Frontend/upload/xservice_04.png.pagespeed.ic.NGi9jRXTXk.png" alt="">
                          </div>
                        </div>
                      </div>
                    </li>
    ...
    <section class="slider-section">
      <div class="tp-banner-container">
        <div class="tp-banner">
          <ul>
            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="../Frontend/upload/slider_new_01.jpg"
              data-saveperformance="off" data-title="Slide">
              <img src="../Frontend/upload/xslider_new_01.jpg.pagespeed.ic.RgCY2ieSzC.jpg" alt="fullslide1"
            ...
            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" data-delay="5000">
              <img src="../Frontend/images/xdummy.png.pagespeed.ic.lRMfmktUso.png" alt="video_business"
              ...
              <div class="tp-caption tp-fade fadeout fullscreenvideo" data-x="0" data-y="0" data-speed="1000"
                ...
                data-aspectratio="16:9" data-forcerewind="on" style="z-index: 2"><video id="revvideo"
                  class="video-js vjs-default-skin" preload="none" poster='../Frontend/images/dummy.png' data-setup="{}">
                  <source src='../Frontend/upload/video.mp4' type='video/mp4' />
                  <source src='../Frontend/upload/video.webm' type='video/webm' />
                  <source src='../Frontend/upload/video.ogv' type='video/ogg' />
                </video>
              </div>
              <div class="tp-caption slider_layer_01 text-center lft tp-resizeme" data-x="center" data-y="220"
                data-speed="1000" data-start="600" data-easing="Power3.easeInOut" data-splitin="none"
            ...
            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="../Frontend/upload/slider_new_03.jpg"
              data-saveperformance="off" data-title="Slide">
              <img src="../Frontend/upload/xslider_new_03.jpg.pagespeed.ic.0dDeZb1yS7.jpg" alt="fullslide1"
                data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
            ...
            <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="../Frontend/upload/slider_new_02.jpg"
              data-saveperformance="off" data-title="Slide">
              <img src="../Frontend/upload/xslider_new_02.jpg.pagespeed.ic.QHr4wT-HDB.jpg" alt="fullslide1"
                data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
        ...
        <div id="owl-featured" class="owl-custom">
          <div class="owl-featured">
            <div class="shop-item-list entry">
              <div class="">
                <img src="../Frontend/upload/xcourse_01.png.pagespeed.ic.XTOvCuUmZu.png" alt="">
                <div class="magnifier">
                </div>
              </div>
          ...
          <div class="owl-featured">
            <div class="shop-item-list entry">
              <div class="">
                <img src="../Frontend/upload/xcourse_02.png.pagespeed.ic.PL7Wu2UcSB.png" alt="">
                <div class="magnifier">
                </div>
              </div>
              <div class="shop-item-title clearfix">
          ...
          <div class="owl-featured">
            <div class="shop-item-list entry">
              <div class="">
                <img src="../Frontend/upload/xcourse_03.png.pagespeed.ic.8e1MyY5M7i.png" alt="">
                <div class="magnifier">
                </div>
              </div>
              <div class="shop-item-title clearfix">
          ...
          <div class="owl-featured">
            <div class="shop-item-list entry">
              <div class="">
                <img src="../Frontend/upload/xcourse_04.png.pagespeed.ic.2rIKmUwjA7.png" alt="">
                <div class="magnifier">
                </div>
              </div>
              <div class="shop-item-title clearfix">
    ...
    <section class="section darkskin fullscreen paralbackground parallax"
      style="background-image:url(../Frontend/upload/xparallax_01.jpg.pagespeed.ic.JPVsQrTu6o.jpg)" data-img-width="1627"
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="image-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
              <img src="../Frontend/upload/xdevice_02.png.pagespeed.ic.w5TutKGgkN.png" alt="" class="img-responsive">
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            ...
            <div class="content-widget">
              <div class="team-members row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="../Frontend/upload/xteam_01.jpg.pagespeed.ic.uNKwi9Xmie.jpg" alt=""
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="../Frontend/upload/xteam_02.jpg.pagespeed.ic.Foo3PN64df.jpg" alt=""
                      class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Adam DEO</h5>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="../Frontend/upload/xteam_03.jpg.pagespeed.ic.Mw22RnI1eL.jpg" alt=""
                      class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Jenny Kennedy</h5>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="team">
                    <img src="../Frontend/upload/xteam_04.jpg.pagespeed.ic.equz9NTtM1.jpg" alt=""
                      class="img-responsive wow fadeInUp">
                    <div class="team-hover-content">
                      <h5>Jennifer DEO</h5>
    ...
    <section class="section fullscreen paralbackground parallax"
      style="background-image:url(../Frontend/upload/xparallax_02.jpg.pagespeed.ic.Sx1_qXOliB.jpg)" data-img-width="1627"
      data-img-height="868" data-diff="100">
        ...
        <div class="row blog-widget">
          <div class="col-md-4 col-sm-6">
            <div class="blog-wrapper">
              ...
              <div class="blog-image">
                <a href="single.html" title=""><img src="../Frontend/upload/xblog_01.jpg.pagespeed.ic.2jVY1j1OMe.jpg" alt=""
          ...
          <div class="col-md-4 col-sm-6">
            <div class="blog-wrapper">
              ...
              <div class="blog-image">
                <a href="single.html" title=""><img src="../Frontend/upload/xblog_02.jpg.pagespeed.ic.VhhhBexs2E.jpg" alt=""
                    class="img-responsive"></a>
              </div>
              <div class="blog-desc">
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
          ...
          <div class="col-md-4 col-sm-6">
            <div class="blog-wrapper">
              ...
              <div class="blog-image">
                <a href="single.html" title=""><img src="../Frontend/upload/xblog_03.jpg.pagespeed.ic.ZGQLz9XvWC.jpg" alt=""
                    class="img-responsive"></a>
              </div>
              <div class="blog-desc">
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="testimonial">
              <img class="alignleft img-circle" src="../Frontend/upload/xstudent_01.png.pagespeed.ic.756JwMcqdq.png" alt="">
          ...
          <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="testimonial">
              <img class="alignleft img-circle" src="../Frontend/upload/xstudent_02.png.pagespeed.ic.y-PM-y4pVj.png" alt="">
          ...
          <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="testimonial">
              <img class="alignleft img-circle" src="../Frontend/upload/xstudent_03.png.pagespeed.ic.uCQY3WNMCJ.png" alt="">
    ...
    <section class="grey section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-2">
            <img src="../Frontend/upload/xclient_01.png.pagespeed.ic.m5NnlxSzhM.png" alt="" class="img-responsive img-thumbnail">
          </div>
          <div class="col-md-2">
            <img src="../Frontend/upload/xclient_02.png.pagespeed.ic.BsH9V4BqCi.png" alt="" class="img-responsive img-thumbnail">
          </div>
          <div class="col-md-2">
            <img src="../Frontend/upload/xclient_03.png.pagespeed.ic.mxzQrepbL_.png" alt="" class="img-responsive img-thumbnail">
          </div>
          <div class="col-md-2">
            <img src="../Frontend/upload/xclient_04.png.pagespeed.ic.Fx2ObIy0Eb.png" alt="" class="img-responsive img-thumbnail">
          </div>
          <div class="col-md-2">
            <img src="../Frontend/upload/xclient_05.png.pagespeed.ic.GBNy2ra72B.png" alt="" class="img-responsive img-thumbnail">
          </div>
          <div class="col-md-2">
            <img src="../Frontend/upload/xclient_06.png.pagespeed.ic.a_uqmnbFy0.png" alt="" class="img-responsive img-thumbnail">
          </div>
        </div>
      </div>
    </section>
              ...
              <ul class="popular-courses">
                <li>
                  <a href="single-course.html" title=""><img class="img-thumbnail"
                      src="../Frontend/upload/xservice_01.png.pagespeed.ic.2iuJZT3CaV.png" alt=""></a>
                </li>
                <li>
                  <a href="single-course.html" title=""><img class="img-thumbnail"
                      src="../Frontend/upload/xservice_02.png.pagespeed.ic.c6RThoxSWC.png" alt=""></a>
                </li>
                <li>
                  <a href="single-course.html" title=""><img class="img-thumbnail"
                      src="../Frontend/upload/xservice_03.png.pagespeed.ic.E_Ew4wn4ZP.png" alt=""></a>
                </li>
                <li>
                  <a href="single-course.html" title=""><img class="img-thumbnail"
                      src="../Frontend/upload/xservice_04.png.pagespeed.ic.NGi9jRXTXk.png" alt=""></a>
                </li>
                <li>
                  <a href="single-course.html" title=""><img class="img-thumbnail"
                      src="../Frontend/upload/xservice_05.png.pagespeed.ic.2iuJZT3CaV.png" alt=""></a>
                </li>
                <li>
                  <a href="single-course.html" title=""><img class="img-thumbnail"
                      src="../Frontend/upload/xservice_06.png.pagespeed.ic.o2Uniwq-y5.png" alt=""></a>
                </li>
                <li>
                  <a href="single-course.html" title=""><img class="img-thumbnail"
                      src="../Frontend/upload/xservice_07.png.pagespeed.ic.H-fRTeeP8u.png" alt=""></a>
                </li>
                <li>
                  <a href="single-course.html" title=""><img class="img-thumbnail"
                      src="../Frontend/upload/xservice_08.png.pagespeed.ic.76ek5JLaEY.png" alt=""></a>
                </li>
                <li>
                  <a href="single-course.html" title=""><img class="img-thumbnail"
                      src="../Frontend/upload/xservice_09.png.pagespeed.ic.FJcG938KC-.png" alt=""></a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <script src="../Frontend/js/bootstrap.min.js%2bretina.js%2bwow.js.pagespeed.jc.pMrMbVAe_E.js"></script>
  ...
  <script src="../Frontend/js/carousel.js%2bcustom.js.pagespeed.jc.nVhk-UfDsv.js"></script>
  <script>eval(mod_pagespeed_6Ja02QZq$f);</script>
  <script>eval(mod_pagespeed_KxQMf5X6rF);</script>

  <script src="../Frontend/rs-plugin/js/jquery.themepunch.tools.min.js.pagespeed.jm.0PLSBOOLZa.js"></script>
  ...
  <script src="../Frontend/js/bxslider.js.pagespeed.jm.X-sF7YFq4Y.js"></script>
  <script
